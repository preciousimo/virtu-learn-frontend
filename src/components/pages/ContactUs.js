          ...
          <div className="col-12 col-lg-6">
            <div className="row justify-content-xl-center">
              <div className="col-12 col-xl-11">
                ...
                <p className="lead fs-4 text-secondary mb-5">We're always on the lookout to work with new possibilities. If you're interested in working with us, please get in touch in one of the following ways.</p>
                <div className="d-flex mb-5">
                  ...
                  <div>
                    ...
                    <address className="mb-0 text-secondary">Lagos, Nigeria</address>
                  </div>
                </div>
                  ...
                  <div className="col-12 col-sm-6">
                    <div className="d-flex mb-5 mb-sm-0">
                      ...
                      <div>
                        ...
                        <p className="mb-0">
                          <a className="link-secondary text-decoration-none" href="tel:+2348149960190">+234 814 996 0190</a>
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="col-12 col-sm-6">
                    <div className="d-flex mb-0">
                      ...
                      <div>
                        ...
                        <p className="mb-0">
                          <a className="link-secondary text-decoration-none" href="mailto:preciousimoniakemu@gmail.com">info@sonipstechnologies.com</a>
                        </p>
                      </div>
                    </div>
                  </div>
